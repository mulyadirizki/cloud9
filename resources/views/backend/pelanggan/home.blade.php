...
@section('content')
    <div class="">
        ...
        <button type="button" class="btn btn-add btn-primary btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg">Tambah Pelanggan</button>
        <button type="button" class="btn btn-import btn-success btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg">Import Data</button>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-8 col-sm-8 ">
                                            <select name="perumahan_id" id="perumahan_id" class="form-control">
                                                ...
                                                @foreach ($perumahan as $value)  
                                                    <option value="{{ $value->id }}">{{ $value->nama_perumahan }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="modal-body">
                            <div class="x_content">
                                ...
                                {{--  <form id="demo-form1" id="form-add-update" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                    {{ csrf_field() }}
                                    <div class="item form-group">
...
@push('script')
    <script type="text/javascript">
        ...
        $('#btn-submit').click(function(event) {
            ...
            $.ajax({
                url: "{{ route('data-pelanggan.store') }}",
                type: 'POST',
                data: {
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('data-pelanggan/' + data_id + '/edit', function (data) {
