...
@section('content')
    <div class="">
        ...
        <button type="button" class="btn btn-add btn-warning btn-sm" data-toggle="modal" data-target=".bs-example-modal-lg">Export Data</button>
        <div class="row">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <button type="button" class="btn btn-danger delete" id="btn-hapus">Hapus
                        Data</button>
                </div>
            </div>
        </div>
...
@push('script')
    <script type="text/javascript">
        ...
        var table = $('#data-pelanggan').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:"{{ route('data-pelanggan.verify') }}",
                data:{
                    _token:"{{csrf_token()}}"
                },
                type:"GET"
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('diterima/' + data_id + '/edit', function (data) {
        ...
        $('#btn-submit').click(function(event) {
            ...
            $.ajax({
                url: "{{ route('data-pelanggan.update') }}",
                type: 'POST',
                data: {
        ...
        $(document).on('click', '.delete', function () {
            ...
            swalWithBootstrapButtons.fire({
                ...
                title: 'PERHATIAN!',
                html: `
                    <p style="color: red;">Jika menghapus Data Pelanggan maka data tersebut hilang selamanya, apakah anda yakin? </p>
                    <div class='col-sm-12'>
                    Masukan alasan penghapusan data pelanggan
